...
Fai.bg = function (i, d, h, c) {
	...
	f = '<div id="popupBg' + i + '" class="J_popup_bg popupBg popupBgForWin ' + c + "\" style='" + b + a + "' onclick='Fai.logDog(200046, 40);'>" + ($.browser.msie && $.browser.version == 6 ? '<iframe id="fixSelectIframe' + i + '" wmode="transparent" style="filter: alpha(opacity=0);opacity: 0;" class="popupBg" style="z-index:-111" src="javascript:"></iframe>' : "") + "</div>";
	...
	c.extend(d.prototype, {
		init: function () {
			var h, k = "",
				...
				q = "",
				l, o, j, n, m = false;
			l = this.popupWindowId;
			h = "<iframe id='popupWindowIframe" + l + "' class='popupWindowIframe' src='' frameborder='0' scrolling='" + this.settings.frameScrolling + "' style='width:100%;height:100%;'></iframe>";
			...
			if (this.settings.displayBg && !this.settings.replaceContent) {
				Fai.bg(l, this.settings.opacity, this.settings.popUpWinZIndex)
			}
			var i = "";
			if (this.settings.popUpWinZIndex) {
				i = "z-index: " + this.settings.popUpWinZIndex
			}
			if (this.settings.replaceContent) {
				i = "animation: initial;"
			}
			j = Fai.top.document.body.clientHeight || Fai.top.document.documentElement.clientHeight;
			n = Fai.top.document.body.clientWidth || Fai.top.document.documentElement.clientWidth;
			...
			if (this.settings.top !== 0 || this.settings.left !== 0) {
				...
				g = "left: " + (n - this.contentWidth) / 2 + "px;top: " + (j - this.contentHeight) / 2 + "px;"
			}
			o = '<div id="popupWindow' + l + '" hasScroll=' + m + "  class='fk-popupWindowVT " + this.settings.popUpWinClass + "' style='" + g + " height:" + this.contentHeight + "px; " + i + "'><div class='pWHead'" + p + "><div class='pWHead_title'>" + this.settings.title + "</div><div style='" + (this.settings.closeBtnHide ? "display: none;" : "") + "' class='pWHead_close'><div class='J_pWHead_close pWHead_close_img'></div></div></div><div class='pWCenter' style='width:" + this.contentWidth + "px;" + q + "'>" + h + "<div class='tabs_extendedLine' style='display:none;'></div></div><div class='pWBottom'><div class='pWBtns'></div></div><div id=\"pwLoading" + l + "\" class='pwLoading' style='height:auto;'></div></div>";
			if (this.settings.replaceContent) {
				Fai.top.$("#popupWindow" + l).css("animation", "initial");
				Fai.top.$("#popupWindow" + l).replaceWith(o)
			} else {
				Fai.top.$("body").append(o)
			}
			this.popupWin = Fai.top.$("#popupWindow" + l);
			this.pWHead = this.popupWin.find(".pWHead");
			this.pWHeadHeight = this.pWHead.height();
			this.pwLoading = this.popupWin.find("#pwLoading" + l);
			if (this.iframeMode) {
			...
			if (Fai.isNull(Fai.top._popupOptions["popup" + l])) {
				Fai.top._popupOptions["popup" + l] = {}
			}
			if (!Fai.isNull(this.settings.callArgs)) {
				Fai.top._popupOptions["popup" + l].callArgs = this.settings.callArgs
			}
			Fai.top._popupOptions["popup" + l].options = this.settings;
			Fai.top._popupOptions["popup" + l].change = false
		},
